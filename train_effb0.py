...
from model import FasterRCNNVGG16, FasterRCNNVGG16Real, FasterRCNNEffB0
...
def train(**kwargs):
    ...
    faster_rcnn = FasterRCNNEffB0(n_fg_class=2)
    ...
    for epoch in range(opt.epoch):
        ...
        if eval_result['map'] > best_map:
            ...
            best_path = trainer.save(best_map=best_map,save_path="checkpoint_effb0")
        if epoch == 9:
